...
public class Geocoder
{
  ...
  public List<double[]> geocode(final String canonicalName, final int streetNumber, final List<String> segmentIDs)
  {
    System.out.println("\nwe r geocoding()");
    ...
    // System.out.println(" seg " + seg.getID() + " low adress=" + seg.getLowAddress()
    // + " high address=" + seg.getHighAddress());
    // }
