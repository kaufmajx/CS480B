...
public class GPGGASentence extends NMEASentence
{
  ...
  public static String buildGPGGA(double lon, double lat)
  {
    ...
    String body = String.format("GPGGA,000000,%02d%08.5f,%s,%03d%08.5f,%s,1,08,1.0,0.0,M,0.0,M,,",
    ...
    return String.format("$%s*%02X", body, checksum);
  }
}
